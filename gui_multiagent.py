...
class MultiAgentGUI:
    ...
    def setup_gui(self):
        ...
        self.test_btn = ttk.Button(control_frame, text="Run Test Scenario", command=self.run_test_scenario)
    ...
    def create_dashboard_tab(self, notebook):
        ...
        self.system_log = tk.Text(log_frame, height=20, state=tk.DISABLED, font=("Consolas", 9))
    ...
    def create_comm_log_tab(self, notebook):
        ...
        self.comm_tree = ttk.Treeview(comm_log_frame, columns=("Time", "From", "To", "Message"), show="headings")
    ...
    def start_system(self):
        ...
        messagebox.showinfo("System Started", "The multi-agent HIDR system is now active.")
    ...
    def stop_system(self):
        ...
        messagebox.showinfo("System Stopped", "The multi-agent HIDR system has been deactivated.")

    def run_test_scenario(self):
        if not self.monitoring_active:
            messagebox.showwarning("System Offline", "Please start the system before running a test.")
            return

        def test_thread():
            self.log_system("Starting test scenario: Suspicious process...")
            result = self.hidr.analyze_process(
                "ransomware.exe",
    ...
    def log_comm(self, from_agent, to_agent, message):
        ...
        self.comm_tree.insert("", "end", values=(timestamp, from_agent, to_agent, message))
    ...
    def update_gui_with_results(self, result):
        self.log_system("Analysis complete. Final Action: " + result.get('final_action', 'N/A'))
