"""
Human-in-the-Loop Demo - Multi-Agent HIDR System
Demonstrates intelligent human approval with AI explanations.
"""
...
def main():
    ...
    # Initialize system WITH human approval
    ...
    result1 = hidr.analyze_process(
        ...
        "suspicious.exe --payload --encrypt",
        5555
    )
    ...
    result2 = hidr.analyze_process(
        ...
        "encryptor.exe --target C:\\Users --key abc123",
        7777
    )
